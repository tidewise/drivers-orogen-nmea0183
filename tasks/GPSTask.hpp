...
#ifndef NMEA0183_GPSTask_TASK_HPP
#define NMEA0183_GPSTask_TASK_HPP

#include "nmea0183/GPS.hpp"
#include "nmea0183/GPSTaskBase.hpp"

namespace nmea0183 {
    class Driver;
    /*! \class GPSTask
     * \brief Parsing of an GPS NMEA0183 stream
     */
    ...
    protected:
        ...
        std::unique_ptr<marnav::nmea::gsa> m_gsa;
        std::unique_ptr<nmea0183::Driver> m_driver;
    ...
    public:
         ...
         *                      configure state.
         */
        GPSTask(std::string const& name = "nmea0183::GPSTask");
