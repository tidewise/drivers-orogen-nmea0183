...
#ifndef NMEA0183__TEST_MARNAVPROCESSRAWSENTENCETASK_TASK_HPP
#define NMEA0183__TEST_MARNAVPROCESSRAWSENTENCETASK_TASK_HPP

#include "nmea0183/test/MarnavProcessRawSentenceTaskBase.hpp"

namespace nmea0183 {
namespace test {
    /*! \class MarnavProcessRawSentenceTask
     * \brief this task has no documentation, write one as a commentblock before the task_context statement in the orogen file
     */
    class MarnavProcessRawSentenceTask : public MarnavProcessRawSentenceTaskBase
    {
        /** The base class is auto-generated by orogen to define the task's interface
         *
         * It is located in the .orogen/tasks folder
         */
        friend class MarnavProcessRawSentenceTaskBase;

    protected:
        void processRawSentence(std::string const& s);

    public:
        /** TaskContext constructor for MarnavProcessRawSentenceTask
         ...
         *                      configure state.
         */
        MarnavProcessRawSentenceTask(std::string const& name = "nmea0183::test::MarnavProcessRawSentenceTask");

        ~MarnavProcessRawSentenceTask();
